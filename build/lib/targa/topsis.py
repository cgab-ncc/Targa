...
def topsis(matrix, criteria_weights, criteria_directions):
    """
    ...
    for d in criteria_directions:
        if d != '+' and d != '-':
            ...
            return
    t = TOPSIS()
    return t.run(matrix=matrix, criteria_weights=criteria_weights, criteria_directions=criteria_directions)
